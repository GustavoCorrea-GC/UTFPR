...
void inserir_vertice(Grafo *G,int x, int M[][MAXI]){
    if (G->qt_ve==0){
        ...
        G->inicio=p;
        G->qt_ve++;
        printf("\n\tInserida a primeira vértice. Número %d\n", x);
        p->Grau=0;
        Matriz(G,M);
        return;
    }
        ...
        f->vertice=p;
        G->qt_ve++;
        printf ("\n\tInserida uma nova vértice. número %d\n",x);
        p->Grau=0;
        Matriz(G,M);
        return;
    }
    ...
    if(G->qt_ve==0){
        ...
        while(aux!=NULL){
            ...
            while(aux2!=NULL){
                ...
                printf("|(%d)|P%d|->", aux2->chave, aux2->peso);
                aux2=aux2->aresta;
            }
            printf ("NULL\n");
            aux=aux->vertice;
...
void imprimeMatriz(Grafo *G, int M[][MAXI]){
    int i, j,l=0,k=1;
    no *p,*q;
    printf("\t__|");
    for(i=1;i<=MAXI;i++){
...
void Prim(Grafo *G, int u){
    ...
    //termina de iniciar a lista para o Prim
        ...
        while(F.quant!=0){
            ...
            while(q!=NULL){
                g=L.inicio;
                while (g->endereco!=q->chave){//faz a lista se alinar com o q
                    g=g->prox;
                    }
                if((Busca_Fila(&F,q->chave)==1)&&(q->peso<g->d)){//se v pertence a Q e w(u, v) < key[v]
                    g->pai=a;
                    g->d=q->peso;
                }
                q=q->aresta;
...
void Menu (Grafo *G, int M[][MAXI]){
    ...
    while (f!=-1){
        ...
        switch(f){
            case 1:
                printf("\n\tDigite o numero do vértice.\n\t");
                scanf("%d", &x);
                inserir_vertice(G,x,M);
                printf("\n\n");
                system("pause");
            break;
        case 2:
            printf("\n\tDigite os dois lados da aresta e o peso da aresta separados por espaço.\n\t");
            scanf("%d", &x);
            scanf("%d", &y);
            scanf("%d", &p);
            inserir_aresta(G,x,y,p,M);
            printf("\n\n");
            system("pause");
            break;
        case 3:
        ...
        case 4:
            ...
            scanf("%d", &x);
            remover_vertice(G,x,M);
            printf("\n\n");
            system("pause");
            break;
        case 5:
            printf("\n\tDigite os dois lados da aresta que deseja remover separados por espaço.\n\t");
            scanf("%d", &x);
            scanf("%d", &y);
            remover_aresta(G,x,y,M);
            printf("\n\n");
            ...
            break;
        case 6:
            printf("\n\tDigite o número da vértice que você quer saber o grau.\n\t");
            scanf("%d", &x);
            if(Grau(G,x)!=-1){
                printf ("\n\tGrau do vértice %d, é %d", x, Grau(G,x));
            }
            printf("\n\n");
            system("pause");
            break;
        ...
        case 9:
            printf("\n\tDigite o número da vértice raiz da busca\n\t");
            scanf("%d", &x);
            Busca_Largura(G, x,0);
            printf("\n\n");
            system("pause");
...
inserir_vertice(&Simples, 2,M);
inserir_vertice(&Simples, 6,M);
inserir_vertice(&Simples, 4,M);
inserir_vertice(&Simples, 5,M);
//inserir_vertice(&Simples, 13,M);
//inserir_vertice(&Simples, 14,M);
inserir_vertice(&Simples, 8,M);
inserir_vertice(&Simples, 3,M);
inserir_vertice(&Simples, 10,M);
//inserir_vertice(&Simples, 15,M);
inserir_vertice(&Simples, 7,M);
inserir_vertice(&Simples, 9,M);
inserir_vertice(&Simples, 1,M);


inserir_aresta(&Simples, 1,5,10,M);
inserir_aresta(&Simples, 1,4,9,M);
inserir_aresta(&Simples, 1,2,7,M);
inserir_aresta(&Simples, 1,10,8,M);
inserir_aresta(&Simples, 1,8,9,M);
inserir_aresta(&Simples, 1,6,8,M);
inserir_aresta(&Simples, 2,4,5,M);
inserir_aresta(&Simples, 2,3,4,M);
inserir_aresta(&Simples, 2,9,9,M);
inserir_aresta(&Simples, 2,10,9,M);
inserir_aresta(&Simples, 3,5,4,M);
inserir_aresta(&Simples, 3, 4,1,M);
inserir_aresta(&Simples, 4,5,3,M);
inserir_aresta(&Simples, 5,6,18,M);
inserir_aresta(&Simples, 6,8,9,M);
inserir_aresta(&Simples, 6,7,9,M);
inserir_aresta(&Simples, 7,8,3,M);
inserir_aresta(&Simples, 7,9,6,M);
inserir_aresta(&Simples, 8,10,2,M);
inserir_aresta(&Simples, 8,9,4,M);
inserir_aresta(&Simples, 9,10,2,M);
//system ("cls");
//imprimir(&Simples);
...
/*remover_aresta(&Simples,7,5);
remover_vertice(&Simples, 9);
printf ("\n");
//imprimir(&Simples,M);*/
return 0;
}
